...
function isOneIntervalContainedInTheOther(intervals) {
    ...
    ..34567...
    */
    if((intervals.elf1.start >= intervals.elf2.start && intervals.elf1.end <= intervals.elf2.end) || (intervals.elf2.start >= intervals.elf1.start && intervals.elf2.end <= intervals.elf1.end)){
            return true;
    }
    return false
}